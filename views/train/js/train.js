...
const start = async () => {
  ...
  const initializeElements = () => {
    document.getElementById('load').addEventListener('change', (event) => uploadModel(knnClassifierModel,event));
    document.getElementById('save').addEventListener('click', async () => downloadModel(knnClassifierModel));
